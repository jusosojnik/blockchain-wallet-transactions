...
const getCoustomCoinbaseTransaction = (address, blockIndex) => {
    const t = new Transaction();
    const txIn = new TxIn();
    txIn.signature = "";
    txIn.txOutId = "";
...
module.exports.signTxIn = signTxIn;
module.exports.getTransactionId = getTransactionId;
module.exports.UnspentTxOut = UnspentTxOut;
module.exports.TxIn = TxIn;
module.exports.TxOut = TxOut;
module.exports.getCoinbaseTransaction = getCoinbaseTransaction;
module.exports.getCoustomCoinbaseTransaction = getCoustomCoinbaseTransaction;
